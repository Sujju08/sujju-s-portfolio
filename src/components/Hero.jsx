  ...
  return (
    <div className='bg-black text-white text-center py-16'>
        ...
        <h1 className='text-4xl font-bold'>
            I'm {" "}
            <span className='text-transparent bg-clip-text bg-gradient-to-r from-green-400 to-blue-500'>Sujan</span>
            , Full-Stack Developer
        </h1>
        <p className='mt-4 text-lg text-gray-300'>
        "I specialize in creating dynamic and responsive web applications with a modern touch."
        </p>
